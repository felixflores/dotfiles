...
alias rb="ruby"
alias scratch="mkdir -p ~/scratch && cd ~/scratch"
...
alias gd="git diff"
alias gf="git fetch"
alias gfresh="git stash -u && git checkout master && git fetch && git pull"
alias gfr="gfresh"
alias gk="gitk"
...
alias gp="ruby -e 'if \`git rev-parse --abbrev-ref HEAD\`.chomp == :master.to_s; print \"Push to **MASTER**? (Y/N) \"; unless gets.chomp.downcase == :y.to_s; puts \"♥ Push-to-Master crisis averted ♥\"; exit 1;end;end' && git push"
